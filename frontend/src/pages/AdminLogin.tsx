...
//       <div className="w-full max-w-2xl bg-white rounded-3xl shadow-xl border border-gray-100 px-16 py-14">
//         {/* Heading */}
...
//             Sign in to your Cupidanza Admin account
//           </p>
//         </div>
...
//           {/* Email */}
//           <div>
//             <label className="block text-[15px] font-semibold text-gray-700 mb-3">
//               Email
//             </label>
...
//               className="w-full h-16 rounded-2xl border border-gray-300 px-6 text-lg outline-none transition focus:border-[#D72638] focus:ring-2 focus:ring-[#D72638]/20"
//               required
//             />
//           </div>
...
//           <p>
//             <strong>Email :</strong> admin@cupidanza.com
//           </p>
