...
const quickLinks = ["Home", "Categories", "Collections", "About", "Contact"];

const categories = ["Sarees", "Kurtis", "Dresses", "Lehengas", "Tops"];
    ...
    <footer className="bg-[#161616] text-gray-300">
      ...
      <div className="max-w-[1450px] mx-auto px-8 py-20">
        <div className="grid gap-14 lg:grid-cols-4">
          ...
          <div>
            <h2 className="text-4xl font-bold text-white">Cupidanza</h2>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-[1450px] mx-auto flex flex-col items-center justify-between gap-4 px-8 py-6 text-sm text-gray-400 lg:flex-row">
          <p>
            © {new Date().getFullYear()} Cupidanza Boutique. All rights
            reserved.
          </p>
